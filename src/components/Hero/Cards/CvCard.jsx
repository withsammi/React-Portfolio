...
const CvCard = () => {
  return (
    <div className="bg-gradient-to-r from-[rgb(32,32,32)] to-[rgb(23,23,23)] flex flex-col lg:flex-row rounded-4xl h-auto w-full md:w-3/4 lg:w-1/2 p-5 group hover:invert transition-all duration-300">
